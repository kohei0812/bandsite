...
<html lang="en">
  <head>
    <title>Register | Stacked State Official Site</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<!-- <form method="post" action="action/userAction.php">
  ...
  <div class="col-lg-6 col-md-12" style="position:relative;">
      <h2>Register</h2>
        ...
        <input class="form-control" id="postcode" name="postcode" type="number">
   ...
   <div class="col-lg-6 col-md-12" style="position:relative;">
    <h2>Attention</h2>
    <p style="font-size: 12px; color:black; line-height:24px;">Your details will only be stored on Stacked State database and will not be distributed to any third parties without your permission. By selecting the boxes above you are giving your consent to use your info for marketing.
...
For further details on our policies and your rights please view our privacy policy. By clicking below, you agree that we may process your information in accordance with these terms.</p>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="position: absolute; bottom:30px; right:20px;">
  Register
</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
         <button class="btn btn-dark" name="signup" type="submit" style="position:absolute; bottom:40px; right:10px;">Register</button>
      </div>
    </div>
  </div>
</div>
