...
<html lang="en">
  <head>
    <title>会員登録 | Stacked State Official Site</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
         <button class="btn btn-dark" name="signup" type="submit" style="position:absolute; bottom:40px; right:10px;">登録</button>
      </div>
    </div>
  </div>
</div>
