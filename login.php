...
<html lang="en">
  <head>
    <title>login | Stacked State Official Site</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
 ...
 <div class="row">
   <div class="col-lg-6 col-md-12" style="position:relative;">
      <form method="post" action="action/accountAction.php">
        ...
        <a href="contact.php"><p>Forgotten your password?</p></a>
        <button name="login" type="submit" class="btn btn-dark" style="position:absolute; bottom:-30px; right:10px;">Login</button>

      </form>        
   </div>
   <div class="col-lg-6 col-md-12" style="position:relative;">
    <h2>Register</h2>
    <p>Are you a new customer?Register to gain account holder benefit while using the website.</p>
    <a role="button" class="btn btn-dark" href="register.php" style="position:absolute; bottom:-30px; right:10px;">Register</a>  
