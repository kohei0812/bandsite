...
<html lang="en">
  <head>
    <title>User Page | Stacked State Official Site</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <div style="color:white;" class="container-fluid bg-dark pl-5 mb-5"> 
   ...
   <nav class="navbar navbar-expand-lg navbar-toggleable-sm navbar-dark">
    ...
    <div class="container w-50 mx-auto my-2">
      ...
      <div class="lang mb-3" style="float:right;">
         <form action="" method="post">
          ...
          <button type="submit" class="btn btn-dark" name="choose">Choose Language</button>
        </form>
       <?php 
        ...
        <tbody class="bg-light">
          ...
          <tr>
            <td colspan="2" class="text-right">
              <a role="button" class="btn btn-light" href="update/updateUser.php?user_id=<?php echo $specificUser['user_id']?>">EDIT</a>
            </td>
          </tr>
    ...
    <div class="container w-50">
      ...
      <!-- Modal -->
<button type="button" class="btn btn-danger btn-block" data-toggle="modal" data-target="#exampleModal">Delete Account</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <a role="button" style="position:absolute; bottom:40px; right:10px;" class="btn btn-danger " href="delete/deleteAccount.php?user_id=<?php echo $specificUser['user_id']?>">Delete Account</a>
