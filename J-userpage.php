...
<html lang="en">
  <head>
    <title>会員情報 | Stacked State Official Site</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <div style="color:white;" class="container-fluid bg-dark pl-5 mb-5"> 
   ...
   <nav class="navbar navbar-expand-lg navbar-toggleable-sm navbar-dark">
     ...
     <div class="navbar-brand">
      ...
      <!-- <div class="container-fluid my-2 text-right">
        <a role="button" class="btn btn-light" href="purchaseHistory.php">Purchase History</a>
        <a role="button" class="btn btn-light" href="userOrder.php">Your Orders</a>
      </div> -->
    ...
    <!-- 0728edit -->
       ...
       <div class="lang mb-3" style="float:right;">
         <form action="" method="post">
          <select class="btn" name="lang" id="">
          <option value="" style="display: none;">選択してください</option>
            <option value="eng">English</option>
            <option value="jap">Japanese</option>
          </select>
          <button type="submit" class="btn btn-dark" name="choose">言語選択</button>
        </form>
       <?php 
        if(isset($_POST['choose'])){
           ...
           if($lang == "eng") {
             ...
             header("Location: J-userpage.php");
           }
      ...
      <table class="table table-bordered mb-3">
        ...
        <tbody class="bg-light">
          <tr>
            ...
            <td style="width:70%;"><?php echo $specificUser['name'] ?></td>
          </tr>
          <tr>
            <td>EMAILアドレス</td>
            <td><?php echo $specificUser['email']?></td>
          </tr>
          <tr>
            <td>郵便番号</td>
            <td><?php echo $specificUser['postcode']?></td>
          </tr>
          <tr>
            <td>ご住所</td>
            <td><?php echo $specificUser['address']?></td>
          </tr>
          <tr>
            <td colspan="2" class="text-right">
              <a role="button" class="btn btn-light" href="update/J-updateUser.php?user_id=<?php echo $specificUser['user_id']?>">編集</a>
            </td>
          </tr>
    ...
    <div class="container w-50">
      ...
      <!-- Modal -->
<button type="button" class="btn btn-danger btn-block" data-toggle="modal" data-target="#exampleModal">退会</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <a role="button" style="position:absolute; bottom:40px; right:10px;" class="btn btn-danger " href="delete/deleteAccount.php?user_id=<?php echo $specificUser['user_id']?>">退会</a>
