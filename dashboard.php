...
<html lang="en">
 ...
 <?php 
 $contactData = $Contact->displayContacts();
                 ...
                 <?php if(!empty($contactData)):?>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      echo sanitize_br($contact);
                      
                      ?>
                    </td>
                    <td>
                      <a role="button" class="btn btn-danger" href="delete/deleteContact.php?contact_id=<?php echo $row['contact_id']?>">Done</a>
                    </td>
