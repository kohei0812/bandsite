    ...
    <div class="row">
       <div class="col-lg-9 col-md-12">
             ...
             <table class="table table-bordered">
               ...
               <tbody class="bg-light">
                 <?php if(!empty($liveData)):?>
                  ...
                  <?php foreach($liveData as $row):?> 
                  <tr>
                    <td>
                      <?php echo $row['live_date']?>
                    </td>
                    <td>
                      <?php echo $row['live_place']?>
                    </td>
                    <td>
                      <?php  echo $row['live_title']?>
                    </td>
                    <td>
                      <?php 
                         echo $row['live_cw']
                    ...
                    <td>
                      <a role="button" class="btn btn-danger" href="delete/deleteLive.php?live_id=<?php echo $row['live_id']?>">Delete</a>
                      <a role="button" class="btn btn-warning" href="update/updateLive.php?live_id=<?php echo $row['live_id']?>">Edit</a>
                      <a role="button" class="btn btn-dark" href="update/moveLive.php?live_id=<?php echo $row['live_id']?>">Move</a>
                    </td>
            ...
            <div class="container pl-5 text-left">
             <table class="table table-bordered">
               <thead class="bg-dark text-light">
                 <th colspan="5">Past Lives</th>
               </thead>
               <tbody class="bg-light">
                 <?php if(!empty($pastLiveData)):?>
                  <tr>
                    <th style="width:10%;"> 
                      Date
                    </th>
                  ...
                  <?php foreach($pastLiveData as $row):?> 
                  <tr>
                    <td>
                      <?php echo $row['past_live_date']?>
                    </td>
                    <td>
                      <?php echo $row['past_live_place']?>
                    </td>
                    <td>
                      <?php  echo $row['past_live_title']?>
                    </td>
                    <td>
                      <?php 
                         echo $row['past_live_cw']
                      ?>
                    </td>
                    <td>
                      <a role="button" class="btn btn-danger" href="delete/deletePastLive.php?past_live_id=<?php echo $row['past_live_id']?>">Delete</a>
                      <a role="button" class="btn btn-warning" href="update/updatePastLive.php?past_live_id=<?php echo $row['past_live_id']?>">Edit</a>
                    </td>
